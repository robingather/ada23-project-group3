...
if __name__ == '__main__':
    ...
    create_subscription("ada23-project", "schedule_notifications", "schedule_notifications_sub")
    pull_message(project="ada23-project", subscription="schedule_notifications_sub")  # replace ada2023 with your project id
